...
if(isset($_POST['name']) && isset($_POST['email']) && isset($_POST['subject']) && isset($_POST['comment'])){
	...
	$mail->Username="kvsalu16@gmail.com";  // Your Mail
	$mail->Password="zcyhoozdjgdqemun"; // Your app password

	$mail->setFrom($email, $name);  
	$mail->addAddress("kvsalu16@gmail.com", "your name"); // (Your Mail) An email address that will receive the email with the output of the form
